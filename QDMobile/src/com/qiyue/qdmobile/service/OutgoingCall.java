...
import com.qiyue.qdmobile.ui.outgoingcall.OutgoingCallChooser;
...
public class OutgoingCall extends BroadcastReceiver {
    ...
    private static final String THIS_FILE = OutgoingCall.class.getSimpleName();
        ...
        if (action.equals(Intent.ACTION_NEW_OUTGOING_CALL)) {
            ...
            if (prefsWrapper.isValidConnectionForOutgoing() || potentialHandlers.size() > 1) {
                ...
                if (gsmCallHandlerId == null) {
                    gsmCallHandlerId = CallHandlerPlugin.getAccountIdForCallHandler(aContext, (new ComponentName(aContext, com.qiyue.qdmobile.plugins.telephony.CallHandler.class)).flattenToString());
                }
