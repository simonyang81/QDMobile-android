...
import com.qiyue.qdmobile.pjsip.PjSipCalls;
import com.qiyue.qdmobile.pjsip.PjSipService;
import com.qiyue.qdmobile.pjsip.UAStateReceiver;
import com.qiyue.qdmobile.service.receiver.DynamicReceiver4;
import com.qiyue.qdmobile.service.receiver.DynamicReceiver5;
import com.qiyue.qdmobile.ui.incall.InCallMediaControl;
	...
	private BroadcastReceiver mReceiver = new BroadcastReceiver() {
		...
		public void onReceive(Context context, Intent intent) {
			...
			if (action.equals(ConnectivityManager.CONNECTIVITY_ACTION)) {
				Log.d(THIS_FILE, "The network status has changed...");
				updateRegistrationsState();
			}
		}
	};
...
//		connectivityManager = (ConnectivityManager) getSystemService(Context.CONNECTIVITY_SERVICE);
	...
	private void applyComponentEnablingState(boolean active) {
        ...
        ComponentName cmp = new ComponentName(this, "com.qiyue.qdmobile.ui.PrivilegedOutgoingCallBroadcaster");
        try {
	...
	public void updateRegistrationsState() {
		...
		// TODO - Handle status bar notification
...
//			notificationManager.cancelRegisters();
			notificationManager.notifyRegisteredAccounts(activeProfilesState,
					prefsWrapper.getPreferenceBooleanValue(SipConfigManager.ICON_IN_STATUS_BAR_NBR), true);
		} else {
//			notificationManager.cancelRegisters();
			notificationManager.notifyRegisteredAccounts(activeProfilesState,
					prefsWrapper.getPreferenceBooleanValue(SipConfigManager.ICON_IN_STATUS_BAR_NBR), false);
		}
